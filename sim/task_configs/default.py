...
def get_config():
    ...
    config.reset_policy_filter_actions = False
    ...
    config.reset_agent_checkpoint = "./reset_ckpts/Go1_PD40.00,5.00_ai_ar1.00_fs3_ppf0.80_ep"
