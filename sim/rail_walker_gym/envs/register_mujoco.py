...
def make_sim_env(
    ...
    elif isinstance(robot.unwrapped(), A1SimWalker):
        robot.control_timestep = 0.05
        robot.control_subtimestep = 0.002
    ...
    if floor_override == "floor":
        ...
        floor = HeightFieldArena(CONFIG_FLOOR_SCALE)
...
def make_full_goal_route_lambda_sim(
    ...
    to_follow = HEIGHTFIELD_ARENA_GOALS["ring_small_inner"]
...
iter_formatted_register_env(
    ...
    format_args_list = [
        ...
        [
            ...
            ("GoalGraph", None, make_full_goal_graph_lambda_sim),
