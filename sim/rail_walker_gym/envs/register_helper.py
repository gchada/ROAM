...
def common_post_process_wrapper(env : gym.Env, action_range: float, filter_actions : bool = False, frame_stack : int = 3, action_history : int = 3, center_init_action : bool = False, log_print = False):
    ...
    if filter_actions:
        env = ActionFilterWrapper(env, robot.control_timestep, robot, 4)
    if action_history > 0:
